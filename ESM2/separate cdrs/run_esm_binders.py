...
# Setup logging
log_file = (
    "/net/mimer/mnt/tank/projects2/emison/language_model/27th_Oct_new_matrices/logs_new/"
    + weight + peptide
    + "_cdr_processing.log"
)
logging.basicConfig(
...
dataset_path = (
    "/net/mimer/mnt/tank/projects2/emison/language_model/full_sequence_data_binders_only.csv"
)
...
def process_sequences(df_filtered, peptide, weight, dataset_name):
    ...
    output_file_path = "/net/mimer/mnt/tank/projects2/emison/language_model/27th_Oct_new_matrices/04.11_new_esm/12.11/sequence_summed_vectors_{dataset_name}_{peptide}_{weight}.csv"
