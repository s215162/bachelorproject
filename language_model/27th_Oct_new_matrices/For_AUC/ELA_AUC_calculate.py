...
for weight in weights_identifier:
    ...
    for peptide in peptides:
        concat_file = os.path.join(
            "/net/mimer/mnt/tank/projects2/emison/language_model/27th_Oct_new_matrices/For_AUC/AUC_data/",
...
results_df.to_csv(os.path.join(output_directory, "auc_scores_ELA.csv"), index=False)
