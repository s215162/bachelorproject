...
file_path = "/net/mimer/mnt/tank/projects2/emison/language_model/27th_Oct_new_matrices/For_AUC/Calculated_AUC/auc_scores.csv"
data = pd.read_csv(file_path, sep=",")  # Adjust the separator if needed

# Print the column names and the first few rows for debugging
...
output_dir = "/net/mimer/mnt/tank/projects2/emison/language_model/27th_Oct_new_matrices/For_AUC/Calculated_AUC"  # Change to your desired output directory
os.makedirs(output_dir, exist_ok=True)  # Create the directory if it doesn't exist
output_file_path = os.path.join(output_dir, "new_auc_values_mean_plot.png")
plt.tight_layout()
