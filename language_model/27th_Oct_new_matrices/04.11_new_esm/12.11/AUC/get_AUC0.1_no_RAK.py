...
output_directory = (
    "/net/mimer/mnt/tank/projects2/emison/language_model/27th_Oct_new_matrices/04.11_new_esm/12.11/AUC"
)
peptides = [
    "ELAGIGILTV",
    "GILGFVFTL",
...
results_df.to_csv(os.path.join(output_directory, "auc_0.1_scores_noRAK.csv"), index=False)
