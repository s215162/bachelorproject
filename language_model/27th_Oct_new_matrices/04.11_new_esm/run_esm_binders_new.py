...
def process_sequences(df_filtered, peptide, weight, dataset_name):
    ...
    # Include the weight in the output file path
    output_file_path = f"/net/mimer/mnt/tank/projects2/emison/language_model/27th_Oct_new_matrices/04.11_new_esm/sequence_summed_vectors_{dataset_name}_{peptide}_{weight}_binders.csv"
