...
log_file_path = '/net/mimer/mnt/tank/projects2/emison/language_model/swaps_matrix/process.log'
logging.basicConfig(
...
# File paths
input_file = '/net/mimer/mnt/tank/projects2/emison/language_model/full_sequence_data.csv'
output_dir = '/net/mimer/mnt/tank/projects2/emison/language_model/swaps_matrix'
