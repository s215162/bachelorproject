...
TBCRALIGN="$HTCPATH"
OUTPUTDIRECTORY=""
weighted_response="n"  # Change this based on your requirement
...
output_name="${OUTDIR}${basename_without_extension}_similarity.csv" # Final output name to save the similarity results
...
# Set WEIGHTS and SUM_WEIGHTS based on selected chains
...
# Divide similarity scores by SUM_WEIGHTS
result['similarity'] /= ${SUM_WEIGHTS}
